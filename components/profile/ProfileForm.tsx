    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-4 space-y-4">
        ...
        <button
          ...
          onClick={handleSave}
          disabled={saving}
          className="min-h-[44px] w-full rounded-lg bg-saffron-500 px-4 py-2 text-sm font-medium text-white hover:bg-saffron-600 disabled:opacity-50 transition-colors"
        >
